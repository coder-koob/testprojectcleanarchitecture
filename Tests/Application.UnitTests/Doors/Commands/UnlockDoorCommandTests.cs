...
public class UnlockDoorCommandTests
{
    private readonly Fixture _autoFixture = new();

    [Fact]
    public async Task Should_Unlock_Door_If_Client_Is_Authorized()
    {
        // Arrange
        ...
        var door = new Door(officeId, doorId, doorName, true, scope);
        ...
        var handler = new UnlockDoorCommandHandler(eventSourceRepoMock.Object, clientServiceMock.Object, currentUserServiceMock.Object);
